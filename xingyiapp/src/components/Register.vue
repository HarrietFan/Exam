  ...
  <div class="shopping-classify">
    <div class="login-wrap">
      <el-form class="login-container">
        ...
        <el-form-item >
          <el-input type="text" v-model="user.userEmail"  placeholder="用户邮箱" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" @click="register" style="width: 100%;">注册</el-button>
        </el-form-item>
        <el-row style="text-align: center;margin-top: -10px;">
          <el-link type="primary" @click="login">登录账号</el-link>
        </el-row>
      </el-form>
    </div>
  </div>
          ...
          .then((res) => {
            ...
            setTimeout(() => {
              if (res.data.status === 200) {
                sessionStorage.setItem('registerUsername', this.user.username);
                sessionStorage.setItem('registerUserImage', res.data.data);
